...
set rc [catch {
  ...
  add_files -quiet D:/Devel/projekty/TMS/project_vivado_20150716.tar/Project_vivado.runs/synth_1/pcie_module.dcp
...
set rc [catch {
  ...
  write_checkpoint -force pcie_module_physopt.dcp
...
set rc [catch {
  ...
  catch { report_timing_summary -max_paths 10 -file pcie_module_timing_summary_routed.rpt -rpx pcie_module_timing_summary_routed.rpx }
...
set rc [catch {
  ...
  write_checkpoint -force pcie_module_postroute_physopt.dcp
  catch { report_timing_summary -warn_on_violation -max_paths 10 -file pcie_module_timing_summary_postroute_physopted.rpt -rpx pcie_module_timing_summary_postroute_physopted.rpx }
...
set rc [catch {
  ...
  write_bitstream -force pcie_module.bit -bin_file
  if { [file exists D:/Devel/projekty/TMS/project_vivado_20150716.tar/Project_vivado.runs/synth_1/pcie_module.hwdef] } {
    catch { write_sysdef -hwdef D:/Devel/projekty/TMS/project_vivado_20150716.tar/Project_vivado.runs/synth_1/pcie_module.hwdef -bitfile pcie_module.bit -meminfo pcie_module.mmi -file pcie_module.sysdef }
  }
